...
int main(int argc,char** argv ){
    ...
    char fileNameSimple2 [100];
    strcat(fileNameSimple2,argv[1]);
    strcat(fileNameSimple2,"_simple2.ps");
    file_simple_eps_2 = fopen(fileNameSimple2, "w");

    contours = find_multiple_contour(I,file,fileOut);

    write_all_simple_segments_eps(I, contours,file_simple_eps_1,file_simple_eps_2);
